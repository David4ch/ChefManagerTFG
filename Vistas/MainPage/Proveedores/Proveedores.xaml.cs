...
using ChefManager.Vistas.MainPage.Proveedores;
...
public partial class Proveedores : ContentPage
{
    ...
    private void Picker_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        switch (seleccionado)
        {
            ...
            case "Bebidas":
                ...
                break;
            case "Productos de la limpieza e higiene":
                listaProveedores.ItemsSource = listaAuxProveedores.Where(u => u.TipoProducto.Equals("Productos de la limpieza e higiene"));
                break;
    ...
    {
        AppShell.Current.GoToAsync(nameof( AgregarProveedor));
    }
}